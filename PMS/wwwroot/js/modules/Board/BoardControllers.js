...
const BoardController = (
    ...
    dom => {
        ...
        const BoardViews = function BoardComponentViews() {
            this.column = (columnHeaderTitle, dbId,itemsNo) => `<div class="kanban-column" id=PMS-Kanban-Column-${dbId}>
            <div class="kanban-column-header" id=PMS-Kanban-Column-Header-${dbId}>
                <h5 class="fs-0 mb-0">${columnHeaderTitle}<span class="text-500">(0)</span></h5>
